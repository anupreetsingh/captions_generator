...
class _HomeScreenState extends State<HomeScreen>
{
  ...
  Future<Map<String,dynamic>?>getResponse(File imageFile) async
  {
    ...
    final imgUploadRequest = http.MultipartRequest("POST",Uri.parse("http://max-image-caption-generator-anupreet2226579-dev.apps.sandbox.x8i5.p1.openshiftapps.com/model/predict"));
